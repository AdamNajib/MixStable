...
Launch the Streamlit app for interactive parameter tuning and visualization:
...
R package stabledist

Python Dependencies (auto-installed via requirements.txt)
